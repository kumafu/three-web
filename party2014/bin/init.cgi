...
my %cf;
#┌─────────────────────────────────
#│ POST-MAIL (UTF-8) : postmail.cgi - 2013/07/15
#│ copyright (c) KentWeb
#│ http://www.kent-web.com/
#└─────────────────────────────────
$cf{version} = 'postmail(UTF-8) v6.72';
#┌─────────────────────────────────
#│ [注意事項]
...
# 本体プログラム【URLパス】
$cf{mail_cgi} = 'http://t-h-r-e-e.com/party2014/bin/postmail.cgi';
